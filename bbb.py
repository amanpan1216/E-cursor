...
def extract_with_regex(pattern_name: str, text: str) -> Optional[str]:
    """
    Extract value using precompiled regex pattern.
...
async def main():
    """
    Main entry point - Tests 12 Braintree sites automatically.
    """
    print("=" * 100)
    print("BRAINTREE CARD CHECKER - BATCH TESTING 12 SITES")
    print("=" * 100)
    ...
    try:
        ...
        print(f"\n>>> FINAL: {len(fully_working)} Working | {len(partial_working)} Partial | {len(not_working)} Failed")
        print("=" * 100)
